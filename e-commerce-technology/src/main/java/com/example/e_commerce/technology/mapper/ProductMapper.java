...
public interface ProductMapper {
    ...
    @Mapping(target = "imageUrls", expression = "java(entity.getImages() != null ? entity.getImages().stream().map(ProductImageEntity::getImage_url).collect(java.util.stream.Collectors.toList()) : new java.util.ArrayList<>())")
